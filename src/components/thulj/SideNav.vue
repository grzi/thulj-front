<template>
    <div>
        <ul class="sidenav sidenav-fixed blue-grey darken-3">
            <li class="logoLi"><a href="#!" class="logo"> <img alt="Vue logo" src="../../assets/jbandit-fox-75.png"></a>
            </li>
            <li>
            ...
            <li><a href="#!" title="Curriculum Vitae">
                <font-awesome-icon icon="id-card" size="2x" color="#afcd37"/>
            </a></li>
            <li><a href="#!" title="Projects">
            ...
            <li><a href="#!" title="Recettes">
                <font-awesome-icon icon="utensils" size="2x" color="#e23d27"/>
            </a></li>
            <li>
                <div class="divider"></div>
            </li>
            <li><a href="#!" title="Jeux">
                <font-awesome-icon icon="gamepad" size="2x" color="#f99b1d"/>
            </a></li>
